...
program alltoallv_init_test
   ...
   call MPI_Alltoallv_init(sbuf, sendcounts, sdispls, MPI_INTEGER, &
                           rbuf, recvcounts, rdispls, MPI_INTEGER, comm, MPI_INFO_NULL, req, ierr)
...
end program alltoallv_init_test
