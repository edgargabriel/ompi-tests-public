...
program allgatherv_init_test
   ...
   do while (j <= MAXLEN)
      ...
      call MPI_Allgatherv_init(out, sendcount, MPI_INTEGER, in, recvcounts, disp, &
                               MPI_INTEGER, MPI_COMM_WORLD, MPI_INFO_NULL, request, ierr)
...
end program allgatherv_init_test
